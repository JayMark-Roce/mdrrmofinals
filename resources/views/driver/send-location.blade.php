...
function displayPendingNotifications(cases) {
    ...
    cases.forEach(caseData => {
        ...
        notificationItem.innerHTML = `
            ...
            <div style="margin-top: 0.5rem; color: var(--driver-navy); font-weight: 800; font-size: 1rem; margin-bottom: 0.75rem;">${caseData.name}</div>
            <div style="margin-top: 0.5rem; color: var(--driver-muted); font-size: 0.9rem; display: flex; align-items: center; gap: 0.5rem; flex-wrap: wrap; margin-bottom: 0.75rem;">
                ...
                <a href="${telHref(caseData.contact)}" style="color: var(--driver-green); font-weight: 800; text-decoration: none; padding: 0.25rem 0.75rem; background: rgba(16, 185, 129, 0.1); border-radius: 8px; transition: all 0.2s;">📞 CALL</a>
            </div>
            ...
            cases.forEach(caseData => {
                ...
                caseItem.innerHTML = `
                    <div style="background: linear-gradient(135deg, #ffffff 0%, #f8fafc 100%); border-radius: 16px; padding: 1.5rem; position: relative; border: 1px solid var(--driver-card-border); box-shadow: 0 4px 20px rgba(0, 0, 0, 0.15), 0 2px 8px rgba(0, 0, 0, 0.1); margin-bottom: 1rem; overflow: hidden;">
                        ...
                        <div style="margin-bottom:0.75rem; color:var(--driver-navy); font-weight:800; font-size:1rem;">${caseData.name}</div>
                        <div style="margin-bottom:0.75rem; color:var(--driver-muted); font-size:0.9rem; display:flex; align-items:center; gap:0.5rem; flex-wrap:wrap;">
                            <i class="fas fa-phone" style="color:var(--driver-blue);"></i>
                            <strong>Contact:</strong> ${caseData.contact} 
                            <a href="${telHref(caseData.contact)}" style="color:var(--driver-green); font-weight:700; text-decoration:none; margin-left:0.5rem; padding:0.25rem 0.75rem; background:rgba(16,185,129,0.1); border-radius:8px; transition:all 0.2s ease;" onmouseover="this.style.background='rgba(16,185,129,0.2)'" onmouseout="this.style.background='rgba(16,185,129,0.1)'">
