...
.success-modal-header, .error-modal-header {
    padding: 1.5rem;
    text-align: center;
    color: #ffffff;
}
...
.success-modal-body, .error-modal-body {
    padding: 2rem 1.5rem;
    text-align: center;
}

.success-modal-footer, .error-modal-footer {
    padding: 1rem 1.5rem 1.5rem;
    text-align: center;
}

.success-modal-btn, .error-modal-btn {
    background: linear-gradient(135deg, #0c2d5a, #1e3a8a);
    color: #ffffff;
    border: none;
    border-radius: 10px;
...
<div id="editAmbulanceModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            <h3><i class="fas fa-edit"></i> Edit Ambulance</h3>
            <button class="modal-close" onclick="closeEditAmbulanceModal()">
                <i class="fas fa-times"></i>
            </button>
        </div>
        <div class="modal-body">
...
<div id="archiveMedicModal" class="modal">
    <div class="modal-content">
        <div class="modal-header" style="background: linear-gradient(135deg, #f59e0b, #d97706);">
            <h3><i class="fas fa-box-archive"></i> Archive Medic</h3>
            <button class="modal-close" onclick="closeArchiveMedicModal()">
                <i class="fas fa-times"></i>
            </button>
        </div>
        <div class="modal-body">
            <p style="margin: 0; font-size: 1rem; color: var(--heading); line-height: 1.6;">
                Are you sure you want to archive <strong id="archiveMedicName"></strong>? 
                This medic will be moved to the archived section and can be restored later.
            </p>
        </div>
        <div class="form-actions">
            ...
            <form id="archiveMedicForm" method="POST" style="display: inline;">
                @csrf
                <button type="submit" class="btn btn-warning">
...
<div id="successModal" class="success-modal" style="display: none;">
    <div class="success-modal-content">
        <div class="success-modal-header">
            <i class="fas fa-check-circle" style="font-size: 3rem; margin-bottom: 0.5rem; display: block;"></i>
            <h3>Success!</h3>
        </div>
...
<div id="errorModal" class="error-modal" style="display: none;">
    <div class="error-modal-content">
        <div class="error-modal-header">
            <i class="fas fa-exclamation-triangle" style="font-size: 3rem; margin-bottom: 0.5rem; display: block;"></i>
            <h3>Error!</h3>
        </div>
