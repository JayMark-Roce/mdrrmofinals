...
<div id="restoreConfirmModal" class="modal" style="display: none;">
    <div class="modal-content">
        <div class="modal-header">
            <h3><i class="fas fa-undo"></i> Restore Medic</h3>
            <button class="modal-close" onclick="closeRestoreConfirmModal()">
                <i class="fas fa-times"></i>
            </button>
        </div>
        <div class="modal-body">
            <p style="margin: 0; font-size: 1rem; color: var(--heading); line-height: 1.6;">
                Are you sure you want to restore <strong id="restoreMedicName"></strong>? 
                This medic will be moved back to the active medics list.
            </p>
        </div>
        <div class="form-actions">
            ...
            <form id="restoreConfirmForm" method="POST" style="display: inline;">
                @csrf
