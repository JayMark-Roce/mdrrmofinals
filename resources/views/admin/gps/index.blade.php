                            ...
                            <section class="case-form-card">
                                ...
                                <div class="form-row">
                                    <div class="form-group compact">
                                        ...
                                        <input type="text" id="case-name" class="form-input compact" placeholder="Enter patient name" required>
                                    </div>
                                    <div class="form-group compact">
                                        <label class="form-label compact">
...
document.getElementById('case-creation-form')?.addEventListener('submit', async function(event) {
    ...
    if (!formData.name || !formData.contact || !formData.address || !formData.destination || selectedAmbulances.length === 0) {
        showInlineNotice('Please fill in all required fields and select at least one driver.', {
